...
export default function Navbar() {
  ...
  return (
    <nav aria-label="Navegación principal" className="fixed top-0 left-0 right-0 z-[999] flex justify-between items-stretch h-11 border-b border-border bg-black/90 backdrop-blur-sm">
      <div className="px-5 flex items-center border-r border-border shrink-0">
        <Link href="/" aria-label="Dani López González — inicio">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480.72 570" className="h-5 w-auto fill-cream" aria-hidden="true" focusable="false">
      ...
      <div className="flex items-center gap-2 px-4 md:px-5 border-l border-border text-[10px] tracking-[0.15em] uppercase text-muted ml-auto md:ml-0 shrink-0">
