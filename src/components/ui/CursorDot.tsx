...
export default function CursorDot() {
  ...
  return <div ref={ref} className="fixed w-1.5 h-1.5 bg-coral rounded-full pointer-events-none z-[9999] -translate-x-1/2 -translate-y-1/2 transition-[transform,opacity] duration-75" />
}
